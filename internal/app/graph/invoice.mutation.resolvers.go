...
func (r *invoiceMutationsResolver) CreateInvoice(ctx context.Context, obj *model.InvoiceMutations) (*model.CreateInvoicePayload, error) {
	invoiceID, err := r.invoicesService.CreateInvoice(ctx)
	if err != nil {
